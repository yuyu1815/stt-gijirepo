...
from .minutes_parser import minutes_parser_service
...
class MinutesGeneratorService:
    ...
    def _generate_minutes_content(self, minutes: Minutes, 
        ...
        # 生成された内容を議事録に設定（パーサーサービスを使用）
        minutes = minutes_parser_service.parse_minutes_content(minutes, minutes_content)
